...
const Base64EncoderDecoder: React.FC<Base64EncoderDecoderProps> = ({ onCopy }) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <label htmlFor="base64-input" className="block text-sm font-medium text-realm-black mb-2">
      ...
      {output && (
        <>
          <div>
            <label htmlFor="base64-output" className="block text-sm font-medium text-realm-black mb-2">
              Result
            </label>
            <textarea
              id="base64-output"
