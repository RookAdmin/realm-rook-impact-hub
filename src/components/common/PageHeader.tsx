...
const PageHeader = ({ title, subtitle, isLarge = false }: PageHeaderProps) => {
  ...
  return (
    <header className="bg-realm-black text-white py-16 md:py-24 mt-20 relative overflow-hidden">
      {/* Spline background */}
      {!isMobile && (
        <div className="absolute inset-0 w-full h-full z-0 pointer-events-none translate-x-1/4">
          <iframe
            src="https://my.spline.design/retrofuturisticcircuitloop-lkOFKYYxIWRszWrK7R4glRiA/"
            frameBorder="0"
            width="100%"
            height="100%"
