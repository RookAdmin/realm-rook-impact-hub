...
export const impactStudies: ImpactStudy[] = [
  ...
  },
  {
    ...
    category: 'SEO',
    problem: 'GreenPath, an innovative sustainability startup, had created groundbreaking eco-friendly products but was invisible in search results. Their target audience couldn't find them organically, forcing reliance on expensive paid acquisition.',
