    ...
    <>
      ...
      <main className="min-h-screen pt-32 pb-16">
        <div className="realm-container">
          ...
          {/* Category-based Service Sections */}
          {serviceCategories.map((categoryGroup, catIndex) => (
            <div key={catIndex} className="mt-16">
              {/* Category Header */}
              <div className="mb-8">
                <h2 className="text-3xl font-display font-bold mb-2">{categoryGroup.category}</h2>
