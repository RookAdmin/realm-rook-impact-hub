...
const ResourcesInsights = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Insights & Resources | Realm by Rook - Industry Thought Leadership</title>
        <meta name="description" content="Strategic insights, creative processes, and thought leadership content. Learn from our experts about design, development, digital strategy, and industry trends." />
        <meta name="keywords" content="design insights, development resources, digital strategy, creative process, thought leadership, industry trends" />
      </Helmet>
      <main>
        <PageHeader 
