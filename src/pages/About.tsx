...
const About = () => {
  ...
  const clients = [
    {
      name: "Client 1",
      logo: "/PartnerLogos/CapitalEngineeringConsultancy.png",
    },
  ...
  // Trusted brands
  const trustedBrands = ["ACME Corp", "Zenith", "Horizon", "Vertex", "Nova"];
          ...
          <div className="realm-container flex flex-col items-center justify-center text-center">
            ...
            >
              ...
              <p className="realm-subheadline text-realm-lightgray mt-6">
                For brands that want to matter, move people, and dominate
                digital. Realm by Rook is where identity, design, and growth
                meet precision.
              </p>
        ...
        <section className="py-20 bg-white">
          <div className="realm-container">
            ...
            >
              ...
              <p className="text-lg mb-6">Aravindh Ravichandran, Founder</p>

              <p className="text-lg text-realm-darkgray max-w-2xl mx-auto">
                Realm by Rook was founded by Aravindh Ravichandran as part of
                the Rook ecosystem, with a mission to help founders and creators
                launch standout digital identities. Realm operates independently
                within Rook, with a sharp focus on providing branding, domains,
                and web systems that are minimal, premium, and built to scale.
                Trusted by emerging startups and visionaries, Realm is designed
                to quietly power bold ideas with elegance and clarity.
              </p>
            </motion.div>
          </div>
        </section>
