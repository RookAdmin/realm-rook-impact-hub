...
const DomainConsultationService = () => {
  ...
  const onSubmit = (data: any) => {
    console.log(data);
    toast.success("Your consultation request has been submitted. We'll get back to you shortly.");
    form.reset();
  };
  ...
  const services = [
    {
      ...
      description: "Expert guidance on selecting domain names that align with your brand and business objectives.",
      icon: <Globe size={24} />
    },
    {
      title: "Domain Security Assessment",
      description: "Comprehensive evaluation of your domain security posture and recommendations for improvement.",
      icon: <Shield size={24} />
    },
    {
      title: "Domain Portfolio Review",
      description: "Analysis of your existing domain portfolio to identify optimization opportunities.",
        ...
        <div className="realm-container">
          ...
          >
            ...
            <p className="realm-subheadline text-white/90 mb-10">
              Your domain is your digital foundation. We ensure it's secure, strategic, and aligned with your brand vision.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <Card key={index} className="p-6 border border-realm-lightgray hover:border-realm-black transition-all duration-300">
        ...
        <div className="realm-container">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-center text-realm-darkgray mb-12">
              Complete the form below to schedule your personalized domain consultation with our experts.
            </p>
        ...
        <div className="realm-container">
          ...
          >
            ...
            <p className="text-white/80 mb-10">
              Our domain experts are ready to help you navigate the complexities of domain acquisition and management.
            </p>
