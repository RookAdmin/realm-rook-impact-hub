...
import { ArrowRight, Check, TrendingUp, Instagram, Linkedin, MessageSquare, Users, Zap } from 'lucide-react';
      ...
      <div className="realm-container relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-2xl mb-12 text-realm-lightgray">
            Social media isn't about being everywhere. It's about showing up where it matters—with strategy, storytelling, and systems.
          </p>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm text-realm-lightgray">Lead Generation</div>
            </div>
          </motion.div>
      ...
      <div className="realm-container">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-realm-darkgray">
            Most brands fall into the trap of random posting. No narrative. No consistency. No conversion.<br />
            We fix that with intentional content, platform-specific playbooks, and data-fed creativity.
          </p>
        </motion.div>
      </div>
    </section>
...
const AnimatedCounter = ({ value, label, icon: Icon }) => {
  ...
  return (
    <div ref={ref} className="bg-realm-black text-white p-8 border border-realm-darkgray">
      <div className="flex items-center gap-4 mb-4">
        {Icon && <Icon size={32} className="text-realm-lightgray" />}
      </div>
      <h3 className="text-3xl md:text-4xl font-bold mb-2">
        {isInView ? (
          <span className="inline-block">{typeof value === 'string' && value.includes('x') ? `${count}x` : count}</span>
        ) : (
          <span className="inline-block">0</span>
        )}
        {typeof value === 'string' && !value.includes('x') && !isNaN(parseInt(value.replace(/[^0-9]/g, ''))) ? value.replace(/[0-9]/g, '') : ''}
      </h3>
    ...
    <section ref={ref} className="py-20 bg-realm-lightgray">
      <div className="realm-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <AnimatedCounter value="5.2x" label="average ROI across all social campaigns" icon={TrendingUp} />
          <AnimatedCounter value="230%" label="increase in engagement within 90 days (B2B client)" icon={MessageSquare} />
          <AnimatedCounter value="40%" label="content reuse through AI repurposing" icon={Zap} />
          <AnimatedCounter value="8.4M+" label="combined impressions delivered for clients last quarter" icon={Users} />
        </div>
        ...
        <div className="mt-12">
          ...
          <div className="overflow-x-auto pb-4">
            <div className="flex gap-6 min-w-max">
              {[1, 2, 3].map((item) => (
                <div key={item} className="bg-white p-6 min-w-[300px] shadow-sm">
  ...
  const services = [
    {
      ...
      description: "Custom audience mapping, platform selection, and funnel optimization for maximum conversion."
    },
    {
      title: "AI-Driven Content Creation",
      description: "Blending human creativity with AI efficiency to produce scroll-stopping content that converts."
    },
    {
      title: "Comment Handling by Custom AI Agents",
      description: "Never miss an opportunity to engage with intelligent, brand-aligned responses."
    },
    {
      title: "Performance Timing & Scheduling",
      description: "Data-backed posting schedule optimized for your audience's peak engagement times."
    },
    {
      title: "Weekly KPI Reports with Human + AI Analysis",
      description: "Clear insights on what's working and actionable recommendations for improvement."
    },
    {
      title: "A/B Testing for Post Styles & CTA Language",
      description: "Continuous optimization through split testing to maximize engagement and conversion."
    },
    {
      title: "Reels & Short-Form Storyboarding",
      description: "Strategic planning and creation of attention-grabbing short-form video content."
    },
  ];
    ...
    <section ref={ref} className="py-20 bg-realm-black text-white">
      <div className="realm-container">
        ...
        >
          ...
          <p className="text-xl text-realm-lightgray">We deploy custom-built AI agents for:</p>
        </motion.div>
          ...
          <div className="relative h-20 md:h-24">
            <div className="absolute inset-x-0 flex justify-between items-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs text-realm-lightgray">AI Strategy</span>
              </div>
              <div className="border-t border-dashed border-realm-lightgray/30 flex-grow mx-2"></div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 rounded-full border border-realm-lightgray/50 flex items-center justify-center mb-2">
                ...
                <span className="text-xs text-realm-lightgray">Content Creation</span>
              </div>
              <div className="border-t border-dashed border-realm-lightgray/30 flex-grow mx-2"></div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 rounded-full border border-realm-lightgray/50 flex items-center justify-center mb-2">
                ...
                <span className="text-xs text-realm-lightgray">Human Review</span>
              </div>
              <div className="border-t border-dashed border-realm-lightgray/30 flex-grow mx-2"></div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 rounded-full border border-realm-lightgray/50 flex items-center justify-center mb-2">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs text-realm-lightgray">Live Metrics</span>
              </div>
            </div>
          </div>
        </motion.div>
...
const SocialProof = () => {
  ...
  const testimonials = [
    {
      quote: "Realm didn't just increase our following. They created movement. We're now a thought leader in our space—and our inbound leads prove it.",
      ...
      <div className="realm-container">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            <Link to="/contact">
              <Button variant="outline" className="realm-button border-white text-white hover:bg-white/10 transition-colors">
    ...
    >
      <div className="realm-container flex flex-col sm:flex-row items-center justify-between">
        <div className="hidden md:block">
          ...
          <p className="text-sm text-realm-lightgray">Only 2 slots left this month</p>
        </div>
  ...
  return (
    <main className="min-h-screen pt-32">
      <div className="realm-container mb-6">
        <ServiceBreadcrumb serviceName="Social Media Marketing" serviceUrl="/services/social-media-marketing" />
      </div>
