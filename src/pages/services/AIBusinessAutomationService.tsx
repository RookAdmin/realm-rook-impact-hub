        ...
        <div className="realm-container">
          ...
          >
            ...
            <p className="realm-subheadline text-white/90 mb-10">
              We turn workflows into ecosystems. From lead generation to client
              onboarding—our automation strategies scale what humans start.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center space-y-8 md:space-y-0">
              <div className="md:w-1/2 md:pr-12">
                ...
                <p className="text-white/90 mb-6">
                  ...
                  <br />
                  We create entire ecosystems—built to scale, adapt, and evolve.
                  <br />
