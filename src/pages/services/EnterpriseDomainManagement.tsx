...
const EnterpriseDomainManagement = () => {
  ...
  const offerings = [
    {
      ...
      description:
        "Strategic organization of your domain assets for optimal management.",
    },
    {
      title: "Auto-Renew + Expiry Monitoring",
      description:
        "Automated systems to prevent accidental domain expirations.",
    },
    {
      title: "Registrar Consolidation",
      description:
        "Centralize domains from multiple registrars for streamlined management.",
    },
    {
      title: "DNS Zone Security & SSL Monitoring",
      description:
        "Continuous monitoring of DNS configurations and SSL certificates.",
    },
    {
  ...
  return (
    <>
      <Helmet>
        <title>
          Enterprise Domain Management | Realm by Rook - Secure Digital Assets
        </title>
        <meta
          name="description"
          content="Manage domains at scale with strategic organization, automated renewals, and DNS security. Tailored for high-scale brands."
        />
        <meta
          name="keywords"
          content="enterprise domain management, DNS security, domain renewals, digital assets, high-scale brands"
        />
      </Helmet>
          ...
          <div className="realm-container">
            ...
            >
              ...
              <p className="text-xl mb-8 text-realm-darkgray">
                From phishing threats to accidental expiries, unmanaged domains
                can:
              </p>
              ...
              <p className="text-lg font-medium">
                We eliminate these risks with full-stack domain lifecycle
                oversight.
              </p>
              ...
              <div className="mt-12 p-8 border border-realm-black">
                ...
                <div className="flex flex-wrap justify-between items-center">
                  <div className="text-center p-4">
                    <div className="h-12 w-12 rounded-full bg-realm-black text-white flex items-center justify-center mx-auto mb-2">
                      1
                    </div>
                    <p>Registration</p>
                  </div>
          ...
          <div className="realm-container">
            ...
            >
              ...
              <p className="text-xl mb-12 text-white/80 max-w-3xl mx-auto">
                Our enterprise DNS + domain monitoring detects and resolves
                issues before they affect your users. We provide 24/7 alerts,
                redundancy planning, and managed renewals.
              </p>
