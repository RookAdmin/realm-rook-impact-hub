...
const SEOService = () => {
  ...
  // SEO services
  const seoServices = [
    { name: 'Keyword Research + Competitive Analysis', description: 'Finding the right terms your customers actually use to find you.' },
    { name: 'Data-Driven On-page SEO', description: 'Optimizing every page element for maximum search visibility.' },
    { name: 'Technical SEO & Site Health', description: 'Fixing the backend issues that can tank your rankings.' },
    { name: 'High-Authority Link Building', description: 'Earning quality backlinks through strategic outreach and content.' },
    { name: 'SEO Content that Converts', description: 'Creating valuable content that ranks and drives action.' },
    { name: 'Analytics + Reporting Dashboards', description: 'Transparent tracking of all key performance metrics.' }
  ];

  // SEO process
  const seoProcess = [
    { name: 'Site Audit', description: 'Comprehensive analysis of current SEO performance and issues.' },
    { name: 'Strategy Blueprint', description: 'Custom roadmap based on your goals, industry, and competitors.' },
    { name: 'Content Plan', description: 'Keyword-focused content calendar aligned with search intent.' },
    { name: 'On-page Fixes', description: 'Implementation of technical and content optimizations.' },
    { name: 'Off-page Strategy', description: 'Authority building through quality link acquisition.' },
    { name: 'Monitoring & Reporting', description: 'Ongoing analysis and strategy refinement.' }
  ];
    ...
    <main className="min-h-screen pt-32 pb-16">
      <div className="realm-container">
        ...
        <section className="py-16 border-t border-realm-lightgray">
          <h2 className="text-3xl font-display font-bold mb-12">Why SEO with Realm?</h2>
        ...
        {/* Our SEO Process */}
        <section className="py-16 border-t border-realm-lightgray">
          <h2 className="text-3xl font-display font-bold mb-12">Our SEO Process</h2>
        ...
        <section className="py-16 border-t border-realm-lightgray">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-7 gap-4">
            {seoTools.map((tool, index) => (
              <div key={index} className="border border-realm-lightgray p-4 hover:border-realm-black transition-all duration-300 flex items-center justify-center h-20">
        ...
        <section className="py-16 border-t border-realm-lightgray">
          ...
          <div className="bg-realm-lightgray p-8">
            <p className="text-lg mb-0">
              We use LLMs to generate optimized content drafts, structured snippets, meta descriptions, and run content gap analysis faster than manual teams.
            </p>
          </div>
        </section>
        ...
        {/* Performance Snapshots */}
        <section className="py-16 border-t border-realm-lightgray">
          <h2 className="text-3xl font-display font-bold mb-12">Performance Snapshots</h2>
        ...
        {/* SEO Packages */}
        <section className="py-16 border-t border-realm-lightgray">
          <h2 className="text-3xl font-display font-bold mb-12">SEO Packages</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Final CTA */}
        <section id="seo-contact-section" className="py-16 border-t border-realm-lightgray text-center">
