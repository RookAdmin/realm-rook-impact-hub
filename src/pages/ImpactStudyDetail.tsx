...
const ImpactStudyDetail = () => {
  ...
  return (
    <main>
      ...
      <div className="bg-realm-black from-realm-black to-gray-900 text-white py-20 md:py-32 relative mt-20 border-b border-white/10">
        <div className="realm-container relative z-10">
          ...
          <div className="grid md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-4">
              {study.companyName && (
                <div className="bg-realm-black rounded-2xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300">
