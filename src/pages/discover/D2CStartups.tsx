...
const D2CStartups = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Designs engineered to captivate and convert every visitor into a loyal customer.",
      icon: MonitorIcon,
    },
    {
      title: "Robust, Scalable Development",
      description:
        "Enterprise-grade technology stacks that support rapid expansion without compromise.",
      icon: CodeIcon,
    },
    {
      title: "Data-Driven SEO Excellence",
      description:
        "Positioned for maximum visibility with proven strategies that generate sustainable traffic.",
      icon: BarChart3Icon,
    },
    {
      title: "Dynamic Social Media Influence",
      description:
        "Amplify your brand presence with campaigns tailored to engage and convert at scale.",
      icon: Share2Icon,
    },
    {
      title: "AI-Enabled Business Automation",
      description:
        "Implement intelligent systems that streamline operations, reduce overhead, and unlock growth potential.",
      icon: CpuIcon,
    },
  ];
  ...
  const growthSteps = [
    {
      ...
      description:
        "Crafted to resonate deeply with target audiences and create lasting differentiation.",
    },
    {
      number: 2,
      title: "Seamless Digital Engineering",
      description:
        "From concept to launch, delivering flawless, scalable platforms.",
    },
    {
      number: 3,
      title: "Impactful Search & Social Growth",
      description:
        "Accelerating discovery and engagement through data-backed methodologies.",
    },
    {
      number: 4,
      title: "Intelligent Automation Integration",
      description:
        "Transforming complex workflows into effortless, efficient operations.",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "Partnering with Realm revolutionized our customer acquisition and operational efficiency. Their approach delivers measurable impact.",
      author: "Leading D2C Founder",
    },
    {
      quote:
        "The automation solutions enabled us to scale rapidly while maintaining impeccable brand experience.",
  ...
  const faqs = [
    {
      ...
      answer:
        "We deliver enterprise-caliber solutions tailored for aggressive growth and long-term brand leadership.",
    },
    {
      question: "How do you ensure alignment with our unique brand vision?",
      answer:
        "Through collaborative strategy development and transparent execution at every step.",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>D2C Startups | Realm by Rook - Elevate Your Brand</title>
        <meta
          name="description"
          content="Comprehensive solutions for D2C brands in branding, UI/UX, development, SEO, social media, and AI automation."
        />
        <meta
          name="keywords"
          content="D2C brands, branding, UI/UX, development, SEO, AI automation, scalable solutions"
        />
      </Helmet>
          ...
          <div className="realm-container">
            ...
            >
              ...
              <p className="text-xl mb-12">
                Complex challenges demand sophisticated solutions. Access the
                expertise that empowers top-tier D2C brands to dominate their
                markets.
              </p>
