...
export const client1 = createClient({
  projectId: import.meta.env.VITE_SANITY_PROJECT_ID_1?.trim(),
  dataset: import.meta.env.VITE_SANITY_DATASET_1?.trim(),
  apiVersion: "2024-03-20",
  useCdn: true,
});

export const client2 = createClient({
  projectId: import.meta.env.VITE_SANITY_PROJECT_ID_2?.trim(),
  dataset: import.meta.env.VITE_SANITY_DATASET_2?.trim(),
  apiVersion: "2024-03-20",
  useCdn: true,
});
